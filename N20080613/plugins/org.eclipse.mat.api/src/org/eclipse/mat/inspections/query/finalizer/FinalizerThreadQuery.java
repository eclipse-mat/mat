...
@Help("Extract Finalizer Thread.\n\n"
                ...
                + "This query shows the daemon thread which is performing the object finalizations.")
public class FinalizerThreadQuery implements IQuery
{
    ...
    public IResult execute(IProgressListener listener) throws Exception
    {
        ...
        return new ObjectListResult("Finalizer Thread", new int[] { finalizerThreadObjects[0] }).asTree(snapshot);
    }
}
