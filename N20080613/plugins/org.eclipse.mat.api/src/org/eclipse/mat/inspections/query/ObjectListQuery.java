...
public class ObjectListQuery implements IQuery
{
    ...
    {
        return inbound ? new InboundObjects(snapshot, objects.getIds(listener)) //
                        : new OutboundObjects(snapshot, objects.getIds(listener));
    }
    ...
    public static class InboundObjects extends Tree
    {
        public InboundObjects(ISnapshot snapshot, int[] objectIds)
        {
    ...
    public static class OutboundObjects extends Tree
    {
        public OutboundObjects(ISnapshot snapshot, int[] objectIds)
        {
            super(snapshot, objectIds);
        }
