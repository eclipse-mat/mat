...
{
    /* package */static interface Bucket
    {
        ArrayInt getObjectIds();
    }
    ...
    public static final class Builder
    {
        ...
        /**
         * Indicates that the calculation of the precise retained sizes should
         * be started right away.
         */
        public Builder setShowPreciseRetainedSizes()
        {
            quantize.resultMetaData = new ResultMetaData.Builder().setShowPreciseRetainedSizes().build();

            return this;
        }

        /**
         * Indicates that the calculation of the approximate retained sizes
         * should be started right away.
         */
        public Builder setShowApproximateRetainedSizes()
        {
            quantize.resultMetaData = new ResultMetaData.Builder().setShowApproximateRetainedSizes().build();
    ...
    /* package */final static class QuantizedResult implements IResultTable
    {
        ...
        public Object getColumnValue(Object row, int columnIndex)
        {
            ...
            {
                return bucket.functions[columnIndex - keyLength].getValue(bucket);
            }
            else if (keyLength == 1)
            {
    ...
    /* package */static class Count implements Function
    {
        ...
        public Object getValue(Bucket row)
        {
            return count;
        }
    }
