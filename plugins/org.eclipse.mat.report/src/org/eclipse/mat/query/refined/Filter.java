...
public abstract class Filter
{
    ...
    private static class NumericFilter extends Filter
    {
        ...
        public boolean setCriteria(String criteria) throws IllegalArgumentException
        {
            ...
            {
                throw new IllegalArgumentException(MessageUtil.format(Messages.Filter_Error_Parsing2, column.getFormatter().format(lowerExample()), column.getFormatter().format(upperExample())) + e.getMessage(), e);
            }
        ...
        protected Double number(String string) throws ParseException
        {
            ...
            Object oresult = column.getFormatter().parseObject(string, pos);
            Number nresult;
