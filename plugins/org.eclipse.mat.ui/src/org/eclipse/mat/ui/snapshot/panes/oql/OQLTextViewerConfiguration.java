...
public class OQLTextViewerConfiguration extends SourceViewerConfiguration {
	...
	public OQLTextViewerConfiguration(ISnapshot snapshot) {
		super();
		//if (snapshot == null) {
		//	throw new IllegalArgumentException("Cannot instantiate content assist without snapshot");
		//}
	...
	public IContentAssistant getContentAssistant(ISourceViewer sourceViewer) {
		...
		//TODO: define a better partitioning to coorectly treat FROM clauses split by a comment.
	...
	public IPresentationReconciler getPresentationReconciler(
		...
		DefaultDamagerRepairer dr =
			new DefaultDamagerRepairer(new OQLScanner());
