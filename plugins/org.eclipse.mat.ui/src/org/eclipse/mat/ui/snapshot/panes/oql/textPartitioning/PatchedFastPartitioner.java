...
/**
 * Overrides the getPartition to correctly support the case in which 
 * provided offset is the position after the last character of the document 
 * as ContentAssistant asks.
 * 
		...
		if (fDocument.getLength() <= offset) {
			...
			try{
				...
				if (category.length > 0){
					...
					//check if the last partition contains the last character of the document.
