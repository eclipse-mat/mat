...
public class MapCollisionRatioQuery implements IQuery
{
    ...
    public IResult execute(IProgressListener listener) throws Exception
    {
        ...
        MapExtractor specificExtractor = new HashMapCollectionExtractor(size_attribute, array_attribute, null, null);
        for (int[] objectIds : objects)
        {
            for (int objectId : objectIds)
            {
                ...
                try
                {
                    ExtractedMap coll = CollectionExtractionUtils.extractMapUnlessSpecific(obj, collection, specificExtractor);
