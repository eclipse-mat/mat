...
public class CollectionFillRatioQuery implements IQuery
{
    ...
    public IResult execute(IProgressListener listener) throws Exception
    {
        ...
        builder.setShowApproximateRetainedSizes();
    ...
    {
        int size = (Integer)hashtableObject.resolveValue(info.getSizeField());
        IObjectArray table  = (IObjectArray)hashtableObject.resolveValue(info.getArrayField());
