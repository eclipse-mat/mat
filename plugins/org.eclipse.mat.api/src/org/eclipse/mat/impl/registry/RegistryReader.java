...
public abstract class RegistryReader<D> implements IExtensionChangeHandler
{
    ...
    protected final String[] extractSubjects(D delegate)
    {
        Subjects subjects = delegate.getClass().getAnnotation(Subjects.class);
        if (subjects != null)
            return subjects.value();

        Subject subject = delegate.getClass().getAnnotation(Subject.class);
