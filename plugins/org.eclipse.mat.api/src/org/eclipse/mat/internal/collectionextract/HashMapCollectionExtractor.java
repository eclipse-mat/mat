...
public class HashMapCollectionExtractor extends HashedMapCollectionExtractorBase {
    public HashMapCollectionExtractor(String sizeField, String arrayField,
    ...
    private void collectEntry(ArrayInt entries, int collectionId, String collectionName,
                    int entryId, ISnapshot snapshot) throws SnapshotException
    {
