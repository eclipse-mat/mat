...
public class ExtractionUtils
{
    ...
    public static JdkVersion resolveVersion(ISnapshot snapshot) throws SnapshotException
    {
        ...
        if ((classes = snapshot.getClassesByName("com.ibm.misc.JavaRuntimeVersion", false)) != null && !classes.isEmpty()) return IBM15;
        else if ((classes = snapshot.getClassesByName("com.ibm.oti.vm.BootstrapClassLoader", false)) != null && !classes.isEmpty()) return IBM16;
        else if ((classes = snapshot.getClassesByName("com.ibm.jvm.Trace", false)) != null && !classes.isEmpty()) return IBM14;
