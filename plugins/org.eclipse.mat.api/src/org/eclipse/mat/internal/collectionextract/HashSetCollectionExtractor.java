...
public class HashSetCollectionExtractor implements MapExtractor {
    ...
    public HashSetCollectionExtractor(String size_attribute, String array_attribute,
            String key_attribute, String value_attribute) {
    ...
    private MapExtractor createHashMapExtractor() {
        return new HashMapCollectionExtractor(size_attribute, array_attribute,
