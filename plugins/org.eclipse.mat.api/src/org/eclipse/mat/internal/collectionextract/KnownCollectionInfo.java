...
public class KnownCollectionInfo implements ICollectionExtractorProvider
{
    ...
    private static CollectionExtractionInfo[] knownCollections = new CollectionExtractionInfo[] {
                    ...
                    new CollectionExtractionInfo("java.beans.beancontext.BeanContextSupport", JdkVersion.except(IBM16), new HashMapCollectionExtractor("children.size", "children.table", "key", "value")), // //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$
                    new CollectionExtractionInfo("java.beans.beancontext.BeanContextSupport", IBM16, new HashMapCollectionExtractor("children.elementCount", "children.elementData", "key", "value")), // //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$
                    ...
                    new CollectionExtractionInfo("java.util.TreeSet", JdkVersion.except(IBM16), new TreeMapCollectionExtractor("m.size", "key", "value")), // //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
                    new CollectionExtractionInfo("java.util.TreeSet", IBM16, new TreeMapCollectionExtractor("backingMap.size", "keys[]", "values[]")), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
